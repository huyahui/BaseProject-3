...
#import "RSA.h"
#define RSA_KEY_BASE64 @"w2y0z1cx"
...
{
    //kCCEncrypt 加密
    return [self encrypt:sText encryptOrDecrypt:kCCEncrypt key:@"w2y0z1cx"];
}

+ (NSString *)decryptWithText:(NSString *)sText
{
    //kCCDecrypt 解密
    return [self encrypt:sText encryptOrDecrypt:kCCDecrypt key:@"w2y0z1cx"];
}
